...
select * from `fine-arbor-421713.bigquery_demos.pageviews`;
...
-- Query cluster table
SELECT * FROM `fine-arbor-421713.bigquery_demos.pageviews_cluster` 
where DATE(datehour) > "2023-03-28"
and wiki ='sr.m'
limit 10;

-- Query partioned cluster table
SELECT * FROM `fine-arbor-421713.bigquery_demos.pageviews_cluster_partition` 
where DATE(datehour) > "2023-03-28"
and wiki ='sr.m'
limit 10;