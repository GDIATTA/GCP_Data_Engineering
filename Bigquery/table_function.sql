...
CREATE OR REPLACE TABLE FUNCTION bigquery_demos.TableFunctionDemo(filter_timestap timestamp) AS 
  (
  SELECT
    id,
    owner_display_name,
...
SELECT
  *
FROM
  bigquery_demos.TableFunctionDemo(TIMESTAMP('2022-06-01 00:00:00.000000 UTC'));
...
JOIN
  bigquery_demos.TableFunctionDemo(TIMESTAMP('2022-01-01 00:00:00.000000 UTC')) a
ON
